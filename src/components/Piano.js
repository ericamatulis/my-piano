...
export function Piano(props) {
    ...
    return (
        <div>
            ...
            <div className="piano">
                <svg id="hand" height="150" viewBox="0 0 595.276 841.89" style={{left:(32*NOTE_TO_POSITION[SONGS[songTitle][1][musicIndex]]-9), top:((SONGS[songTitle][1][musicIndex].length>2) ? 150 : 260) }}>
